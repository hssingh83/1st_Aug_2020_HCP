...
public class TC0005_login_With_Partner_Developer extends basePropertiesFile{
	...
	public void Create_User () throws IOException, InterruptedException {
		...
		user_Tab.CreateUser("Partner Developer","Developer","hari@preempt.com");
		user_Tab.logoutUSER();
		user_Tab.loginUser("Partner Developer");	
...
//	}
	...
	public void Cleaning_User_TestData_As_Client_Customer_developer () throws IOException, InterruptedException {
	 ...
	 user_Tab.DeleteUser("Partner Developer");
