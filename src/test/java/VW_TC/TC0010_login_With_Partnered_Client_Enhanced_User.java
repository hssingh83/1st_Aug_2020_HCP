...
public class TC0010_login_With_Partnered_Client_Enhanced_User extends basePropertiesFile{

	private static Logger log =LogManager.getLogger(TC0010_login_With_Partnered_Client_Enhanced_User.class.getName());
	...
	user_Tab.CreateUser("Partnered Enhanced","Enhanced User","hsingh@preempt.com");
	user_Tab.logoutUSER();
	user_Tab.loginUser("Partnered Enhanced");	
...
user_Tab.DeleteUser("Partnered Enhanced");
